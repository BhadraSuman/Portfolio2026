...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Self-hosted reverse proxy & tunneling engine written in Go & Next.js to expose localhost to the public internet instantly over multiplexed WebSockets.',
    highlights: [
      'Engineered a high-concurrency Go proxy server & CLI handling concurrent HTTP requests over single WebSocket frames using Go channels & goroutines.',
      'Designed Next.js 15 management dashboard with NextAuth GitHub OAuth, MongoDB, and dynamic API key provisioning.',
      'Configured automated wildcard Let\'s Encrypt SSL, Docker Compose orchestration, and Nginx reverse proxy routes.',
    ],
    tags: ['Go (Golang)', 'Gorilla WebSockets', 'Go Concurrency', 'Next.js 15', 'Cobra CLI', 'MongoDB', 'Docker'],
